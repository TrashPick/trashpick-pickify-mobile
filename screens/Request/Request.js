        ...
        <SafeAreaView style={{flex:1}}>
            ...
            <View style={styles.container}>
                <Camera
                    ...
                    switchState={switchCamera()}
                />
                 <View style={styles.screenContent}>
                    <LottieView source={lottie} autoPlay loop style={{height:100,weight:100}}/>
                    <Text style={styles.heading}>Want to request pickup?</Text>
                    <View style={{paddingVertical:40,justifyContent:'center'}}>
                        <Text style={styles.slogan}>Start scheduling your first pickup on Pickify</Text>
                    </View>
                </View>
                    <View style={styles.btnContainer}>
                     <Button type="signup" onClick={switchCamera(true)} title="Take image"/>
                    </View>
            </View>
        </SafeAreaView>
    )
